...
//	m_dist_5(outL,nframes,divider);
//	m_dist_4(outL,nframes,divider);
//	m_dist_3(outL,nframes,multiplier);
//	m_dist_2(outL,nframes,multiplier);
//	m_dist_1(outL,nframes,multiplier);
	m_dist_0(outL,nframes,multiplier);
	return 0;      
}
 /**
